...
2. (Optional) Same for CIS Summary report. Go to the specific directory where the CIS compliance report was generated by running the following:
...
9. Even you can see the compliance reports in section Tenant CIS Compliance section, in case you performed the optional actions in the previous labs. If you click on the last section of the menu, TENANT CIS COMPLIANCE, you will see something similar to:
