...
![Help button](https://raw.githubusercontent.com/oracle-livelabs/common/main/labs/need-help/images/help-button2.png)
...
1. In the subject line please provide the **Workshop Name** (see example).
    ![Email](https://raw.githubusercontent.com/oracle-livelabs/common/main/labs/need-help/images/e-mail.png)
...
1. Double-check that you are using the information and credentials provided to you in the lab banner.
    ...
    ![Lab banner](https://raw.githubusercontent.com/oracle-livelabs/common/main/labs/need-help/images/banner-info-highlight.png)

2. Make sure you are using the tenancy, username, and password provided to you in the lab banner.

    ![Login information](https://raw.githubusercontent.com/oracle-livelabs/common/main/labs/need-help/images/login-demo1.png)

3. If you need to view your login information anytime, click **View Login Info**.

    ![View Login Info](https://raw.githubusercontent.com/oracle-livelabs/common/main/labs/need-help/images/view-login-info.png)
...
2. If you can't find your compartment in the drop-down box, make sure you *set your region* to the one provided in the lab banner.
    ...
    ![Set region](https://raw.githubusercontent.com/oracle-livelabs/common/main/labs/need-help/images/compartment-select.png)
...
## Cannot Access Cloud Shell?
   ...
   ![Policy Missing Error](https://raw.githubusercontent.com/oracle-livelabs/common/main/labs/need-help/images/policy-missing.png " ")
...
2. Select the compartment you are assigned to (check which compartment you are assigned to on the LiveLabs *Login Info* page). Expand the **root** compartment and then the **Livelabs** compartment. Select the compartment assigned to you.
   ![Lab banner](https://raw.githubusercontent.com/oracle-livelabs/common/main/labs/need-help/images/banner-info-highlight.png)
   ![Select Compartment](https://raw.githubusercontent.com/oracle-livelabs/common/main/images/console/select-compartment.png " ")

3. Relaunch your cloud shell. You should be able to open your cloud shell.
   ![Cloud Shell](https://raw.githubusercontent.com/oracle-livelabs/common/main/images/console//cloud-shell.png " ")

## Cannot Connect to the Marketplace Compute Instance Using a Private SSH Key?

   ![Policy Missing Error](https://raw.githubusercontent.com/oracle-livelabs/common/main/labs/need-help/images/private-ssh-key-denied.png " ")
