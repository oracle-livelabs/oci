...
| `CONTAINER_INSTANCE_NAME`      | The image name of the container instance the will be created. Add a name that you want.                                                                                                                                                                         |
| `CONTAINER_DISPLAY_NAME`      | The display image name of the container instance. Add a name that you want.                                                                                                                                                                                     |
