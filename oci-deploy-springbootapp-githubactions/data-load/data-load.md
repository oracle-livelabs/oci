...
In this lab, you will configure the GitHub Repository Secrets and Variables required for the CI/CD workflow to
authenticate with Oracle Cloud Infrastructure (OCI) and deploy resources.
...
1. Following Task 1, add each secret together with its corresponding value as shown in the table below.
    ...
    | `OCI_CLI_KEY_CONTENT`             | The full content of the private key.<br/> See [Generating an API Signing Key](https://docs.oracle.com/en-us/iaas/Content/API/Concepts/apisigningkey.htm#two)<br/> Important: The key pair must be in PEM format.          |
    ...
    | `OCI_BACKEND_LB_BACKEND_SET_NAME` | The backend set name ![Image alt text](images/img_2.png)                                                                                                                                                                  |   
...
8. Click Add variable.
    ...
    | `IMAGE_REPO`              | The name of the Docker repository in OCIR.                                                                                                                                                                                                                      |
    ...
    | `CONTAINER_INSTANCE_NAME` | The name to assign to the container instance that will be created. Please provide an appropriate name.                                                                                                                                                          |
    | `CONTAINER_DISPLAY_NAME`  | The display image name of the container instance. Add an appropriate name.                                                                                                                                                                                      |
    | `DB_HOST`                 | The PostgresDb host.                                                                                                                                                                                                                                            |
    | `DB_NAME`                 | Add "postgres"                                                                                                                                                                                                                                                  |
