...
1. Após fazer o login você receberá uma mensagem de sucesso no navegador. Retorne ao DBeaver e veja que o teste da conexão está concluído, basta clique em OK e depois clicar em **Finish** para salvar a configuração.
