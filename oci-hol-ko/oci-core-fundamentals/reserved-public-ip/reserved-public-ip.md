...
>**노트**: _작성일(2025년 12월) 기준으로 OCI에서 Reserved Public IP는 무료입니다. 사용시 별도 비용이 발생하지 않습니다._
...
1. 왼쪽 상단의 **Navigation Menu**를 클릭하고 **Networking**으로 이동한 다음 **IP Management** 하위의 **Reserved public IPs**를 선택합니다.
    ...
    https://cloud.oracle.com/networking/ip-management/public-ips
...
3. **Networking** 탭 하위의 **Attached VNICs** 항목에서 Primary VNIC을 볼 수 있습니다. 이름을 클릭합니다.

5. VNIC 상세화면에서 **IP administration** 탭의 **IPv4 Addresses** 영역에서 할당된 Private IP와 Public IP를 볼 수 있습니다.

7. Primary IP의 오른쪽 액션 메뉴에서 **Edit**를 클릭합니다.
...
5. VNIC 상세화면에서 **IP administration** 탭의 **IPv4 Addresses** 영역에서, 오른쪽 액션 메뉴에서 **Edit**를 클릭합니다.
