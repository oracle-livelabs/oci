...
2. Open and Explore Access Certifications
   ...
   As part of quarterly controls, the Sales VP needs to certify that only authorized team members can create purchase requisitions. Instead of combing through spreadsheets or multiple reports, he accesses **Access Certifications** that utilizes AI for embedded insights and Generative AI brings to surface risks and speedy decisions. </br>
      ...
      ![Application Home](images/image036.png " ")
      ...
      ![Access Certications](images/image037.png " ")
   ...
   In the **Certifier Worksheet**, you can see all users who have access to creating a requisition and their assigned roles in one place and an indicator of pending actions. </br>
      ...
      ![List of pending Certifications](images/image038.png " ") 
...
3. Review the Briefing Report
   ...
   No need to interpret technical privileges or switch to another report — the Generative AI summary gives them everything in context.
      ...
      ![Role Briefing Panel](images/image039.png " ") 
   ...
   Based on this context, you can now make a quick, confident decision — whether to Keep or Remove the role — and provide a short justification directly in the worksheet.</br>
      ...
      ![Risk Management List of Privileges](images/image040.png " ") 
...
1. Download detailed Role Briefing document.
   ...
   With just one click, the system generates a comprehensive PDF containing all of the same insights — the AI-generated summary, privilege details, usage history, and risk indicators — neatly organized by section.
      ...
      ![Download Briefing Report](images/image041.png " ")
   ...
   The export automatically stamps the date and confirms it was ‘**Generated by AI on** *today’s date*', giving a clear audit trail of when and how the review was performed.</br>
      ...
      ![Briefing Report](images/image042.png " ")
   ...
   That means less administrative work and more confidence that her access certification is fully documented, compliant, and ready for audit
      ...
      ![Briefing Report Panel](images/image043.png " ")
