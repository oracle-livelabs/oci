...
1. First you will log in and navigate to **Insights Data**.
      ...
      ![Login Page](images/image047.png " ")
   ...
   Let’s see how the Insights provide items for action and facilitates collaboration across various stakeholders. 
      ...
      ![Insights Data Tiles](images/image048.png " ")
...
2. Review the insights presented on the dashboard
  ...
  It seems the revenue for “**Sales US – East**” has increased while in contrast “**Sales US – West**” shows declining revenue.  This situation requires further investigation.  Let’s review this leveraging the Insights.
   ...
   ![Insights Data Dashboard](images/image049.png " ")
...
1. Review the list of insights
   ...
   This exercise will focus on just the Anomaly type.  There is a high-level explanation of the Insight, its status, and when it was created.  
      ...
      ![Insights Data List](images/image050.png " ")
      ![AI In Action](images/image006.png " ")

2. Open and Review one of the detected anomalies

   Let us identify the factors behind Sales East's strong performance.  Filter the Insights to review anomaly generated for “**Sales US – East- Energy storage & EV Charging**”

      > In the search box, type *energy storage* and select “**Sales US – East- Energy storage & EV Charging**”

      ![Insights Data Search](images/image051.png " ")
   ...
   The model has generated an anomaly for Sales US Eastern region’s “Credit Lines and Leases” products.  This product portfolio has several product lines, and the anomaly is generated at the total level.
      ...
      ![Insights Data Search Result](images/image052.png " ")
...
3. Review the details behind the Insight for Sales US East
      ...
      ![Insights Data Details](images/image053.png " ")
...
1. Create a Generative AI Summary
   ...
   Insights also provides the ability to use Generative AI (GenAI) to automatically generate narrative summaries for a parent level Insight.  The entities / products contributing to the anomaly is automatically detected and narrated in a organized, automated summary. 
      ...
      ![Insights Data Summarize Action](images/image054.png " ")

      ![Insights Data](images/image006.png " ")

   Complete the fields as described below.
      > 1.	Provide a name for the **Summary** starting with your initials: *XXX East Energy Storage*
      ...
      ![Insights Data Dialog Box](images/image055.png " ")
   ...
   This summary can be taken to reports and/or presentations as ready to use content with all relevant data points.
      ...
      ![Insights Data Generated Summary](images/image056.png " ")
      ![Insights Data](images/image006.png " ")
...
1. Return to the Insight
      ...
      > Click on the **Details** link to see the contents of the Insight again.  

      ![Insights Data Details Page](images/image057.png " ")
...
2. Add your observations of the Insight
   ...
   Adds your comments to the Insight providing additional reasoning for the anomaly.  Tagging is also enabled in comments with # (hashtags).  You can include # (hashtags) in comments, containing relevant key words, which then can be used to filter the Insights.  
      ...
      ```txt
<copy>
         The new #AIdriven targeted #marketcampaign proved to be a big hit with significant sales in Energy Storage, especially in the '5kwh Residential Battery' product line.
</copy>
      ```

   ![Insights Data Comments](images/image058.png " ")
...
3. Tag other users and ask them to review the Insight
   ...
   ![Insights Data Tags](images/image059.png " ")
