...
2. Locate and open the Opportunity.
     ...
     ![Application Home](images/image002.png " ")
      ...
      As a sales representative, when I log into CRM to get my day started, I’m quickly brought to my list of opportunities. I see a new opportunity in my list for Enterprise generator package and want to do my due diligence.

     > Click on the opportunity **Solar Data Center** link.
...
1. Initiate the **Deal Advisor**.
     ...
     > 1.	In the search bar, type *Deal Advisor*
...
3. Ask the AI Agent a follow up question
    ...
    > Close the agent by clicking the **X** in the top right of the agent
      ...
      ![Send eMail](images/image008.png " ")
...
1. Create and send email
    ...
    >  In the search bar type in *send email* and select the **Send Email** option
      ...
      ![Send eMail](images/image009.png " ")

    We will utilize the built in AI to generate an email and automatically send it to our customer. 

    > -   Add a **Subject** like *Solar Agreement*
    > -   In the AI bar at the bottom of the email editor type in the text below
   
      ```txt
      <copy>
      Dear Alex Last week, we reached an exclusive agreement to supply solar panels to Insync's new data center. Create an email telling Alex it's time to meet and review terms and conditions.
      </copy>
      ```
      ...
      ![Generate eMail](images/image010.png " ")
