...
1. In this activity you will learn the power and ease building Agentic AI with the Oracle AI Agent Studio
    ...
    ![AI Agent Team](../05c-embed-agent-hcm/images/benimage001.jpg)
...
2. The first step is to navigate to AI Agent Studio.
    ...
    ![Navigate to AI Agent Studio](../05c-embed-agent-hcm/images/benimage002.jpg)
...
3. You’ve previously created your first Agent.  Now, you’ll create an Agent Team with a Supervisory Agent and assign some Worker Agents.
    ...
    ![Open tools](../05c-embed-agent-hcm/images/benimage003.jpg)
...
4. Create an Agent Team.
    ...
    ![Create Agent Team](../05c-embed-agent-hcm/images/benimage004.jpg)
...
5. Define the Agent Team.
     ...
     * Description: **Agent Team for Benefits and FMLA** <br>
     ...
     ![Create Tool](../05c-embed-agent-hcm/images/benimage005.jpg)
...
6. You’ve defined your Agent Team, so it’s time to add a Supervisor agent.
     ...
     ![Create Agent](../05c-embed-agent-hcm/images/benimage006.jpg)
...
7. Define Supervisor Agent Details.
    ...
    * Description: **Supervisor Agent for Benefits and FMLA** <br>
     ...
     ![Create Agent](../05c-embed-agent-hcm/images/benimage007.jpg)
...
8. Next you'll add some worker agents.  You can scroll through the list of available agents, or use the Ask Oracle field to filter the results.  You'll do the latter.
    ...
    ![Add Tool](../05c-embed-agent-hcm/images/benimage008.jpg)
...
10. You'll add one more worker agent.  First, you'll change the search filter.
    ...
    ![Add Tool](../05c-embed-agent-hcm/images/benimage010.jpg)
...
12. Your Agent Team, with a Supervisor Agent and two Worker Agents is complete.  We can now hide the left Agents panel to see our full Agent Team.
    ...
    ![start debug](../05c-embed-agent-hcm/images/benimage012.jpg) <br>
...
13. Feel free to admire your newly created Agent Team. Before we embed it in the Application UI, you should test it.
    ...
    ![start debug](../05c-embed-agent-hcm/images/benimage013.jpg) <br>
...
18. The AI Agent is deployed to the Application UI via a Guided Journey.  A Guided Journey allows you to embed specific information in standard application screens.  In addition to using a Guided Journey to embed an AI Agent (today's example), Guided Journeys can also be used to embed documents, analytics, URLs, Learning, Videos and more.  And like all configurations, Guided Journey configurations are automatically maintained during the release update process.  So, here you will create a Guided Journey.
    ...
    ![agent dialogue 3](../05c-embed-agent-hcm/images/benimage018.jpg) <br>

19. You'll create your Guided Journey here.  It's quite simple.

    > (1) Click the ![Plus create button](../gen-images/plus-create-small.jpg) button.

    ![agent dialogue 3](../05c-embed-agent-hcm/images/benimage019.jpg) <br>

20. Name your Guided Journey
...
21. Next, you'll add a Task to this Guided Journey.  This is where we specify a Task Type of Agent and reference the Benefits Agent Team you've assembled.
    ...
    > (3) Click the **Save** button ![Create Button](../gen-images/savedark.jpg) on the bottom right.
     ...
     ![enter guided journey task information](../05c-embed-agent-hcm/images/benimage021.jpg)

22. You’re almost done with the Guided Journey creation.  The last step is to Activate it to make it available for use.

     > (1) Click the Activate button ![Activate button](../gen-images/activate.jpg) on the top right<br>

     > (2) Click the Home icon ![Home Button](../gen-images/home.jpg) in the top toolbar to return to the application home page and get ready for the next step.

    ![agent dialogue 3](../05c-embed-agent-hcm/images/benimage022.jpg) <br>

23. Now, you'll go to the screen where you will embed the AI Agent Team using the Guided Journey you created.
...
25. You are now in the New Absence screen where you could manually create an absence request.  But you want to make this earlier for your users by allowing them to ask questions related to Absence benefits and have the AI Agent assist with the creation of an Absence.  You'll use Visual Builder to configure the page and display the Guided Journey you created.
    ...
    ![agent dialogue 3](../05c-embed-agent-hcm/images/benimage025.jpg) <br>
...
27. Now, you can simply specify the Guided Journey you'd like to display on this screen by performing the following steps.
    ...
    ![agent dialogue 3](../05c-embed-agent-hcm/images/benimage027.jpg) <br>

28. The New Absence screen displays a new banner containing Benefits Agent Guided Journey.
...
29. The Agent appears in a sliding panel from the right.  You can interact with your agent via the Ask Oracle field at the bottom of the panel.  Based on your defined agent, you can ask about your Benefits information and even have the Agent create an absence request for you.
    ...
    ![agent dialogue 3](../05c-embed-agent-hcm/images/benimage029.jpg) <br>

30. The Agent will respond with information, so you'll ask an additional question.
    ...
    ![agent dialogue 3](../05c-embed-agent-hcm/images/benimage030.jpg) <br>

31. The Agent checks with HCM Cloud and confirms existing leave requests, if any.  It also offers to create a new request for you if you provide the requested start and end dates.
...
33. Let’s go back to the homepage so we can confirm the creation of our absence.
    ...
    ![agent dialogue 3](../05c-embed-agent-hcm/images/benimage033.jpg) <br>

34. The AI Agent has created your absence request and now you want to find it.

    > 1. In the Search field, type **existing absences** and select **Existing Absences - Me** from the resulting dropdown.

    ![agent dialogue 3](../05c-embed-agent-hcm/images/benimage034.jpg) <br>

35. There it is!  ![up arrow icon](../gen-images/checkeredflag.jpg)

    > ![agent dialogue 3](../05c-embed-agent-hcm/images/benimage035.jpg) <br>
...
* **Last Updated By/Date** - Charlie Moff, Casey Doody, Sajid Saleem; January 2026