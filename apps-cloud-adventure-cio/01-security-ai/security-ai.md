...
8.	You will now search for the required policy and add it.
 ...
 > (2) Select the **Create Supplier Negotiation** privilege entry as shown.
...
11.	While there are other steps we can perform, we going to skip to Step 7 to add roles to this user.
...
13.	Searching for a user
 ...
 > (1) Type “Pat.ProcurementManager” in the search form then Select his name when found. <br>
