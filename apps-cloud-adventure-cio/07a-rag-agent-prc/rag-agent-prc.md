...
6. **Note:** Now we’ll add the documents to our tool.  The documents you will add are located in the **Procurement Documents** folder on your laptop's Desktop.
    ...
    * Description: Enter **Procurement Policy Documents**<br>
    ...
    > (2) Click on the ![Drag and Drop](../gen-images/dandd.jpg) region <br>
    ...
    ![Add Documents](../07a-rag-agent-prc/images/poaimage006.jpg)

7. After all 4 files/documents have been loaded, you can proceed with the Save.

    > Click the **Save** ![Home Icon](../gen-images/save.jpg) button on the bottom right

    ![Suppliers View](../07a-rag-agent-prc/images/poaimage007.jpg)
...
11. Define the Details of the Agent.
    ...
    * Prompt: The value for the prompt field is available in the **Prompt – CA Procurement Policy Advisor.txt** file that is available in the **Procurement Prompt** folder on your desktop.  Please open this file and copy the contents into the Prompt field.  <br><br>
         ![Alert Flat](../gen-images/cautionflagextrasmalltransparent2.png) ***Please note that the Prompt*** is a critical part of the Agent Definition as it provides guidance for the Agent.  To streamline this step, we've pre-created the prompt.  It's available as described below.<br>
...
12. You’ve now created your first Agent.  Now you’ll add Tools to the Agent.  You'll add a mix of standard tools, tools created earlier in the Cloud Adventure, and tools that you've just created.
    ...
    > Click the Tools icon ![Create Button](../gen-images/toolhammericon.jpg) on the left.
...
16. You’ve just created your first Agent, complete with added Tool(s).  Next, you’ll create an Agent Team with a Supervisory Agent and assign some worker agents.
    ...
    > Click the **Agent Teams** button/tab ![Agent Teams](../gen-images/agentteams.jpg) on the button of the page.

    ![Add Tools Create](../07a-rag-agent-prc/images/poaimage016.jpg) <br>

17. Create an Agent Team.

    > Click the **+ Add** button ![Add Button](../gen-images/addw.jpg).
    > ![Add Tools Create](../07a-rag-agent-prc/images/poaimage017.jpg)
...
18. Define the Agent Team.
     ...
     * Description: **Purchase Requisition Agent Team leverages worker agents Procurement Policy Advisory and Purchase Requisition Agent.** <br>
     ...
     > (2) Click the Questions tab <br>
       ...
       ![Create Agent](../07a-rag-agent-prc/images/poaimage018.jpg)
...
19. You can provide one or more starter questions to assist users in interacting with the Agent Team.
     ...
     > (2) Click the **Create** button ![Create Button](../gen-images/createb.jpg) on the bottom right.
       ...
       ![Create Agent](../07a-rag-agent-prc/images/poaimage019.jpg)
...
20. You’ve defined your Agent Team, so it’s time to add a Supervisor agent.
   ...
   ![Create Agent](../07a-rag-agent-prc/images/poaimage020.jpg)
...
21. Define Supervisor Agent Details.
    ...
    * Description: **Cloud Adventure Purchase Requisitions Supervisor Agent** <br>
     ...
     > (2) Click the **Create** button ![Create Button](../gen-images/createb.jpg) on the bottom right.
       ...
       ![Create Agent](../07a-rag-agent-prc/images/poaimage021.jpg)
...
22. Next you'll add some worker agents.
     ...
     > Click the **+** icon ![Plus Icon](../gen-images/plusicon.jpg) next to **CIO## Procurement Policy Advisor Agent**, where ## is replaced with your user number.
       ...
       ![Create Agent](../07a-rag-agent-prc/images/poaimage022.jpg)

23. You can review the details of the agent.

    > Click the Add button ![Add Button](../gen-images/addb.jpg).

    ![Add Tools Complete](../07a-rag-agent-prc/images/poaimage023.jpg) <br>
...
24. You'll add one more worker agent.
     ...
     ![Create Agent](../07a-rag-agent-prc/images/poaimage024.jpg)

25. You can review the details of the agent.

    > Click the **Add** button ![Add Button](../gen-images/addb.jpg).

    ![Add Tools Complete](../07a-rag-agent-prc/images/poaimage025.jpg) <br>
...
26. Your Agent Team, with a Supervisory Agent and two Worker Agents, is now ready to test.
    ...
    ![start debug](../07a-rag-agent-prc/images/poaimage026.jpg) <br>
...
27. You can now begin a dialog with the Agent.
    ...
    ![agent dialogue 1](../07a-rag-agent-prc/images/poaimage027.jpg) <br>
...
28. The Agent will response with information.  In this Debug mode, the Agent will also show you source and processing information (yellow boxes).  These will not be available to end-users once deployed.
    ...
    ![agent dialogue 2](../07a-rag-agent-prc/images/poaimage028.jpg) <br>
...
29. You decide to not worry about requesting anything non-standard.
    ...
    ![agent dialogue 3](../07a-rag-agent-prc/images/poaimage029.jpg) <br>
...
30. The Agent may notice that you have some incomplete PO Requisitions and will request your my input.
    ...
    ![agent dialogue 3](../07a-rag-agent-prc/images/poaimage030.jpg) <br>
...
31. The agent will ask you to confirm.
    ...
    ![agent dialogue 3](../07a-rag-agent-prc/images/poaimage032.jpg) <br>

32. The agent needs a little more information.

    > In the **Ask Oracle** dialog box on the bottom right of the screen, enter **Requested delivery data is Aug 31st, 2025 and the quantity is 1** and hit the return key or click the **Up Arrow** icon ![up arrow icon](../gen-images/uparrow.jpg)

    ![agent dialogue 3](../07a-rag-agent-prc/images/poaimage033.jpg) <br>
...
33. The agent has created your requisition.
    ...
    ![agent dialogue 3](../07a-rag-agent-prc/images/poaimage034.jpg) <br>

34. The agent can link you directly to the Purchase Requisition screen.

    > Click the **here** link in the agent response.

    ![agent dialogue 3](../07a-rag-agent-prc/images/poaimage035.jpg) <br>
...
34. You’re now in Self-Service Procurement and can see the new Requisition that the Agent created.
    ...
    ![agent dialogue 3](../07a-rag-agent-prc/images/poaimage036.jpg) <br>
