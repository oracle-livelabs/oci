...
1. In this activity you will learn the power and ease building Agentic AI with the Oracle AI Agent Studio
    ...
    ![AI Agent Team](../05b-agent-team-hcm/images/agent-team-hcm-image001.jpg)
...
2. The first step is to navigate to AI Agent Studio.
    ...
    ![Navigate to AI Agent Studio](../05b-agent-team-hcm/images/agent-team-hcm-image002.jpg)
...
3. You’ve previously created your first Agent.  Now, you’ll create an Agent Team with a Supervisor Agent and assign some Worker Agents.
    ...
    ![Open tools](../05b-agent-team-hcm/images/agent-team-hcm-image003.jpg)
...
4. Create an Agent Team.
    ...
    ![Create Agent Team](../05b-agent-team-hcm/images/agent-team-hcm-image004.jpg)
...
5. Define the Agent Team.
     ...
     * Description: **Agent Team for Benefits and FMLA** <br>
     ...
     ![Create Tool](../05b-agent-team-hcm/images/agent-team-hcm-image005.jpg)
...
6. You’ve defined your Agent Team, so it’s time to add a Supervisor agent.
     ...
     ![Create Agent](../05b-agent-team-hcm/images/agent-team-hcm-image006.jpg)
...
7. Define Supervisor Agent Details.
    ...
    * Description: **Supervisor Agent for Benefits and FMLA** <br>
     ...
     ![Create Agent](../05b-agent-team-hcm/images/agent-team-hcm-image007.jpg)
...
8. Next you'll add some worker agents.  You can scroll through the list of available agents or use the Ask Oracle field to filter the results.  You'll do the latter.
    ...
    ![Add Tool](../05b-agent-team-hcm/images/agent-team-hcm-image008.jpg)
...
9. You can review the details of the agent before adding.
    ...
    ![Add Tools Complete](../05b-agent-team-hcm/images/agent-team-hcm-image009.jpg) <br>

10. You'll add one more worker agent.  First, you'll filter on something different.

    >  (1) Delete your previous Ask Oracle filter and enter **F1 FMLA** in the Ask Oracle Filter and press the **<****Enter****>** key or select **F1 FMLA** from the resulting dropdown.<br>

    >  (2) Click the ![Plus Icon](../gen-images/plusicon.jpg) icon next to **F1 FMLA Absence Agent.**.<br>

    ![Add Tool](../05b-agent-team-hcm/images/agent-team-hcm-image010.jpg)

11. You can review the details of the agent.

    > (1) Click the **Add** button ![Add Button](../gen-images/addb.jpg).

    ![Add Tools Complete](../05b-agent-team-hcm/images/agent-team-hcm-image011.jpg) <br>
...
12. Your Agent Team, with a Supervisor Agent and two Worker Agents, is complete.  We can now hide the left Agents panel to see our full Agent Team.
    ...
    ![start debug](../05b-agent-team-hcm/images/agent-team-hcm-image012.jpg) <br>
...
13. Feel free to admire your newly created Agent Team. Time to test it and see how it responds to your requests.
    ...
    ![start debug](../05b-agent-team-hcm/images/agent-team-hcm-image013.jpg) <br>
...
15. The Agent will respond with information.  In this Debug mode, the Agent will also show you source and processing information (yellow boxes).  These will not be available to end-users once deployed.
    ...
    ![agent dialogue 2](../05b-agent-team-hcm/images/agent-team-hcm-image015.jpg) <br>
...
16. The Agent checks with HCM Cloud and confirms existing leave requests, if any.  It also offers to create a new request for you, if you provide the requested start and end dates.
    ...
    ![agent dialogue 3](../05b-agent-team-hcm/images/agent-team-hcm-image016.jpg) <br>
...
17. The agent confirms that your request has been created.
    ...
    ![agent dialogue 3](../05b-agent-team-hcm/images/agent-team-hcm-image017.jpg) <br>
...
18. Let’s go back to the homepage so we can confirm the creation of our absence.
    ...
    ![agent dialogue 3](../05b-agent-team-hcm/images/agent-team-hcm-image018.jpg) <br>
...
19. The AI Agent has created your absence request and now you want to find it.
    ...
    ![agent dialogue 3](../05b-agent-team-hcm/images/agent-team-hcm-image019.jpg) <br>

20. There it is!  ![up arrow icon](../gen-images/checkeredflag.jpg)

     > (1) The agent has submitted your FMLA request with the appropriate dates.  You can click on FMLA to see additional information and/or add additional details, but we'll end this adventure here.
