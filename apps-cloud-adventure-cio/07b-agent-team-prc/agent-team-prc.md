...
1. In this activity you will learn the power and ease building Agentic AI with the Oracle AI Agent Studio
    ...
    ![AI Agent Team](../07b-agent-team-prc/images/agent-team-prc-image001.jpg)
...
2. The first step is to navigate to AI Agent Studio.
    ...
    ![Navigate to AI Agent Studio](../07b-agent-team-prc/images/agent-team-prc-image002.jpg)
...
3. You’ve previously created your first Agent.  Now, you’ll create an Agent Team with a Supervisor Agent and assign some Worker Agents.
    ...
    ![Open tools](../07b-agent-team-prc/images/agent-team-prc-image003.jpg)

4. Create an Agent Team.

    > (1) Click the **+** button ![Plus Icon](../gen-images/plusicon.jpg)<br>
    > ![Add Tools Create](../07b-agent-team-prc/images/agent-team-prc-image004.jpg)

5. Define the Agent Team.

     > (1) Enter the fields as described below:
     * Agent Team Name: **CIOXX Purchase Requisition Agent Team** where **XX** is replaced with your user number. <br>
     ...
     * Description: **Agent Team with worker agents Procurement Policy Advisor and Purchase Requisition Agent.** <br>
     ...
     ![Create Agent](../07b-agent-team-prc/images/agent-team-prc-image005.jpg)
...
6. You’ve defined your Agent Team, so it’s time to add a Supervisor agent.
   ...
   ![Create Agent](../07b-agent-team-prc/images/agent-team-prc-image006.jpg)


7. Define Supervisor Agent Details.

     > (1) Enter the fields as described below:
    * Agent Team Name: **CIOXX Purchase Requisition Supervisor Agent** where **XX** is replaced with your user number.<br>
    * Family: Select **PRC** from the dropdown<br>
    * Product: Select  **Self Service Procurement** from the dropdown<br>
    ...
    * Description: **Cloud Adventure Purchase Requisitions Supervisor Agent** <br>
    ...
    ![Create Agent](../07b-agent-team-prc/images/agent-team-prc-image007.jpg)

8. Next you'll add some worker agents.

    >  (1)  Enter **CIOXX**, where **XX** is replaced with your user number, in the Ask Oracle field and press the **<****Enter****>** key or select **CIOXX** from the resulting dropdown.<br>
    ...
    ![Create Agent](../07b-agent-team-prc/images/agent-team-prc-image008.jpg)

9. You can review the details of the agent.

    > (1) Click the Add button ![Add Button](../gen-images/addb.jpg).

    ![Add Tools Complete](../07b-agent-team-prc/images/agent-team-prc-image009.jpg) <br>
...
11. You can review the details of the agent.
    ...
    ![Add Tools Complete](../07b-agent-team-prc/images/agent-team-prc-image011.jpg) <br>

12. Your Agent Team, with a Supervisor Agent and two Worker Agents, is now ready to test.
    ...
    ![start debug](../07b-agent-team-prc/images/agent-team-prc-image012.jpg) <br>
...
13. You can now begin a dialog with the Agent.
    ...
    ![agent dialogue 1](../07b-agent-team-prc/images/agent-team-prc-image013.jpg) <br>

14. The Agent will respond with information.  In this Debug mode, the Agent will also show you source and processing information (yellow boxes).  These will not be available to end-users once deployed. The agent provides a response. But we need more information, so we'll ask additional questions.
    ...
    ![agent dialogue 2](../07b-agent-team-prc/images/agent-team-prc-image014.jpg) <br>
...
15. You decide to not worry about requesting anything non-standard.
    ...
    ![agent dialogue 3](../07b-agent-team-prc/images/agent-team-prc-image015.jpg) <br>

16. The agent queries for any incomplete PO Requisitions previously submitted by you and may request your input.
    ...
    ![agent dialogue 3](../07b-agent-team-prc/images/agent-team-prc-image016.jpg) <br>

17. The agent needs a little more information.
    ...
    ![agent dialogue 3](../07b-agent-team-prc/images/agent-team-prc-image017.jpg) <br>

18. The agent has created your requisition.
    ...
    ![agent dialogue 3](../07b-agent-team-prc/images/agent-team-prc-image018.jpg) <br>

19. The agent can link you directly to the Purchase Requisition screen.

    > (1) Click the **here** link in the agent response.

    ![agent dialogue 3](../07b-agent-team-prc/images/agent-team-prc-image019.jpg) <br>
