...
4. Create an Agent Team.
    ...
    > ![Add Tools Create](../07b-agent-team-prc/images/poaimage004.jpg)

5. Define the Agent Team.

     > (1) Enter the fields as described below:
     * Agent Team Name: **CIOXX Purchase Requisition Agent Team** where ## is replaced with your user number. <br>
     ...
     * Description: **Agent Team with worker agents Procurement Policy Advisor and Purchase Requisition Agent.** <br>
     ...
     ![Create Agent](../07b-agent-team-prc/images/poaimage005.jpg)
...
6. You’ve defined your Agent Team, so it’s time to add a Supervisor agent.
   ...
   ![Create Agent](../07b-agent-team-prc/images/poaimage006.jpg)


7. Define Supervisor Agent Details.

     > (1) Enter the fields as described below:
    * Agent Team Name: **CIOXX Purchase Requisition Supervisor Agent** where ## is replaced with your user number.<br>
    * Family: Select **PRC** from the dropdown<br>
    * Product: Select  **Self Service Procurement** from the dropdown<br>
    ...
    * Description: **Cloud Adventure Purchase Requisitions Supervisor Agent** <br>
    ...
    ![Create Agent](../07b-agent-team-prc/images/poaimage007.jpg)
...
8. Next you'll add some worker agents.
    ...
    ![Create Agent](../07b-agent-team-prc/images/poaimage008.jpg)

9. You can review the details of the agent.

    > (1) Click the Add button ![Add Button](../gen-images/addb.jpg).

    ![Add Tools Complete](../07b-agent-team-prc/images/poaimage009.jpg) <br>
...
10. You'll add one more worker agent.
    ...
    ![Create Agent](../07b-agent-team-prc/images/poaimage010.jpg)

11. You can review the details of the agent.

    > (1) Click the **Add** button ![Add Button](../gen-images/addb.jpg).

    ![Add Tools Complete](../07b-agent-team-prc/images/poaimage011.jpg) <br>
...
12. Your Agent Team, with a Supervisory Agent and two Worker Agents, is now ready to test.
    ...
    ![start debug](../07b-agent-team-prc/images/poaimage012.jpg) <br>
...
13. You can now begin a dialog with the Agent.
    ...
    ![agent dialogue 1](../07b-agent-team-prc/images/poaimage013.jpg) <br>
...
14. The Agent will respond with information.  In this Debug mode, the Agent will also show you source and processing information (yellow boxes).  These will not be available to end-users once deployed. The agent provides a response. But we need more information, so we'll ask additional questions.
    ...
    ![agent dialogue 2](../07b-agent-team-prc/images/poaimage014.jpg) <br>
...
15. You decide to not worry about requesting anything non-standard.
    ...
    ![agent dialogue 3](../07b-agent-team-prc/images/poaimage015.jpg) <br>
...
16. The agent queries for any incomplete PO Requisitions previously submitted by you and may request your input.
    ...
    ![agent dialogue 3](../07b-agent-team-prc/images/poaimage016.jpg) <br>
...
17. The agent needs a little more information.
    ...
    ![agent dialogue 3](../07b-agent-team-prc/images/poaimage017.jpg) <br>
...
18. The agent has created your requisition.
    ...
    ![agent dialogue 3](../07b-agent-team-prc/images/poaimage018.jpg) <br>

19. The agent can link you directly to the Purchase Requisition screen.

    > Click the **here** link in the agent response.

    ![agent dialogue 3](../07b-agent-team-prc/images/poaimage019.jpg) <br>
...
20. You’re now in Self-Service Procurement and can see the new Requisition that the Agent created.
    ...
    ![agent dialogue 3](../07b-agent-team-prc/images/poaimage020.jpg) <br>
