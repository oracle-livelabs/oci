...
1. In this activity you will learn the power and ease building Agentic AI with the Oracle AI Agent Studio
    ...
    ![AI Agent Team](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image001.jpg)
...
2. The first step is to navigate to AI Agent Studio.
    ...
    ![Navigate to AI Agent Studio](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image002.jpg)
...
An Agent team is a group of AI agents collaborating on tasks, where a supervisor agent manages, coordinates, and monitors the activities of the other agents to ensure cohesive team performance.
    ...
    ![Open tools](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image003.jpg)

4. Select your assigned Agent Team.

    >  (1) Enter **CIOXX Purchase** in the Search Bar, where **XX** is replaced with your user number, press the **<****Enter****>** key or select **XX** from the resulting dropdown.<br>

    >  (2) Click on the **Draft** button ![Draft Button](../gen-images/draft-button.png).<br>

    >  (3) Click the **Pencil icon** to edit the CIOXX Purchase Requisition Agent Team where **XX** is your user number.

    > ![Add Tools Create](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image004.jpg)
...
5. Next you'll add some worker agents. You can scroll through the list of available agents or use the Ask Oracle field to filter the results.  You'll do the latter.
    ...
    >  (2)  Enter **CIOXX Procurement**, where XX is replaced with your user number, in the Ask Oracle field and press the **<****Enter****>** key or select **CIOXX Procurement** from the resulting dropdown.<br>
    >  (3)  Click the ![Plus Icon](../gen-images/plusicon.jpg) icon next to **CIOXX Procurement Policy Advisor Agent**, where **XX** is replaced with your user number.<br>

    ![Create Agent](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image005.jpg)

6. You can review the details of the agent before adding.

    > (1) Click the Add button ![Add Button](../gen-images/addb.jpg).

    ![Add Tools Complete](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image006.jpg) <br>
...
8. You can review the details of the agent.
    ...
    ![Add Tools Complete](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image008.jpg) <br>
...
9. Your Agent Team, with a Supervisor Agent and two Worker Agents, is now ready to test.
    ...
    ![start debug](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image009.jpg) <br>
...
10. You can now begin a dialog with the Agent.
    ...
    ![agent dialogue 1](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image010.jpg) <br>
...
11. The Agent will respond with information.  In this Debug mode, the Agent will also show you source and processing information (yellow boxes).  These will not be available to end-users once deployed. The agent provides a response. But we need more information, so we'll ask additional questions.
    ...
    ![agent dialogue 2](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image011.jpg) <br>
...
12. You decide to not worry about requesting anything non-standard.
    ...
    ![agent dialogue 3](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image012.jpg) <br>
...
13. The agent queries for any incomplete PO Requisitions previously submitted by you and may request your input.
    ...
    ![agent dialogue 3](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image013.jpg) <br>
...
15. The agent has created your requisition.
    ...
    ![agent dialogue 3](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image015.jpg) <br>

16. The agent can link you directly to the Purchase Requisition screen.

    > (1) Click the **here** link in the agent response.

    ![agent dialogue 3](../07d-pre-agent-team-prc/images/pre-agent-team-prc-image016.jpg) <br>
