...
8. Next you'll add some worker agents.  You can scroll through the list of available tools, or use the Ask Oracle field to filter the results.  You'll do the latter.
    ...
    >  (2)  Note that Steps 2 and 3 are the same.  The first click activates that region and the second actually adds the agent.<br><br>
            Click the **+** icon ![Create Button](images/plusicon.jpg) next to **CIOXX Benefits Advisor Agent**, where XX is replaced with your user number.<br><br>
...
10. You'll add one more worker agent.  First, you'll filter on something different.
 ...
 >  (1)  1.	Delete your previous Ask Oracle filter and enter **FMLA** in the Ask Oracle Filter and press the <enter> key or select **FMLA** from the resulting dropdown.

    >  (2)  Note that Steps 2 and 3 are the same.  The first click activates that region and the second actually adds the agent.

            Click the **+** icon ![Create Button](images/plusicon.jpg) next to **CA FMLA Absence Agent.**, where XX is replaced with your user number.

    >  (3)  Click the **+** icon ![Create Button](images/plusicon.jpg) next to **CA FMLA Absence Agent.**, where XX is replaced with your user number.
