# Lab 4: Creating Oracle APEX Application for Receipt processing (Optional)
...
Onclick on submit button invoke Apex **Process** by name *process file*, This will invoke the PL/SQL procedure passing the document id and filename of uploaded file.
