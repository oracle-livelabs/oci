...
Provide the URL for FAQs or upload a PDF file with Questions and Answers or a HTML page.
...
Click on **Preview** icon in the top navigation next to **Train** button, 
