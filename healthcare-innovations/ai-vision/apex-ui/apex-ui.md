...
1. Create **MACHINE\_LEARNING\_CONFIGS** to store Machine Learning Configuration Details.
  ...
  USING INDEX  ENABLE
    ...
    **Sample Data**  
    ...
    Your-Bucket-Name is the Bucket Name where Image is temporarily uploaded.
...
## Task 5: Create Page to Upload file and display results
 
TBC
  
## Task 6: Analyze and evaluate your model
