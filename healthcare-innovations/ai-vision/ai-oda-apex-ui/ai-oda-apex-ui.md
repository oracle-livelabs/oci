...
From Oracle Digital Assistant (ODA) and Oracle Mobile Cloud (OMC) Downloads [Downloads](https://www.oracle.com/downloads/cloud/amce-downloads.html) Under **Web SDK** download latest client **Oracle Web SDK 23.04 - Latest**
...
Run the index.html file from your web browser, This will show the disconnected status

![ODA Setup](images/oda-setup-3.png " ")

## Task 2: Get channel id from ODA console. 

Login to ODA and under Channels, copy the channel id

![ODA Setup](images/oda-setup-4.png " ")

## Task 3: Configure settings.js file

Edit **settings.js** file under scripts folder, 
...
<copy>
 const chatWidgetSettings = {
        ...
        // rest of the stuff in the Js file 
    };
</copy>
```
...
Now the chatbot is connected with ODA channel.

![ODA Setup](images/oda-setup-5.png " ")

You can see Auto complete questions and get corresponding answers.

![ODA Setup](images/oda-setup-6.png " ")

## Task 4: Upload CSS, Image and JS files to Oracle APEX 

Upload CSS, Image and JS files to Oracle APEX under \Shared Components\Static Application Files

![ODA Setup](images/oda-setup-10.png " ")

![ODA Setup](images/oda-setup-11.png " ")

CSS file can be customized for placement of chat icon and colors. 

```css 
    <copy>
    /* chatbot style #302D29 */ 
...
Add **Static Content** under APEX Body region
...
Instead of user initiating conversation, you can have bot initiate the conversation, to do this update settings.js with following 
...
If you want bot initiated conversation instead of user initiated conversation, then the bot should send message to the client browser once it is connected, this we can acheive by updating YAML flow in ODA as shown below.

![ODA Setup](images/oda-setup-12.png " ")

Use a good YAML editor like Visual Studio Code to edit and format YAML file and copy paste into ODA Flow.
...
From the auto complete questions user selects
...
User says *Bye* and Bot understands the **exit intent**
