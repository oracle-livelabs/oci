...
4. Select the pencil icon to edit your agent team:

   ![Open Agent Team](images/image001.png " ")

5. Next we will add a supervisor agent to the team.<br/><br/>
...
6. Fill in the details as follows with a description of your choice.  Make sure to start the agent name with ***YOUR INITIAL CODE***.<br/>
...
7. Next we will add our custom agent that we built in the last module to inquire about supplier inventory levels.
...
8. Click **Add** to add your agent to the team:

   ![Add custom agent to agent team](images/image005.png " ")

9. Finally we'll adjust the initial agent questions to help us find a specific requisition.
...
6. Next ask the following question:
