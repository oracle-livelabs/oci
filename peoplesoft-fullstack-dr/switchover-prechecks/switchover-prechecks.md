...
5. Click on **Actions** and then click **Run prechecks** section.
...
1. Click on **Plan executions** tab and select the **FSCM92-FSDR-Switchover-From-Ashburn-To-Phoenix-Prechecks** plan execution.Initially, it will show all the **Built-in Prechecks** as *queued or in-progess*
