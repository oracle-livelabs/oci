...
* Understand how to clone and then to create your own Github repo with Github CLI.
* Create and update  GtHub Secrets and Variables
* Run a workflow from Github Action using UI or  Github CLI.
...
* The Lab requires you to run a Bash/Shell script so the best would be to run the Lab from a Unix like machine 
